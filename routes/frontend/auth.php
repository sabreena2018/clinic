...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('logout-as', 'LoginController@logoutAs')
        ->name('logout-as');
    ...
    if (is_numeric(config('access.users.password_expires_days'))) {
        Route::get('password/expired', 'PasswordExpiredController@expired')
            ->name('password.expired');

        Route::patch('password/expired', 'PasswordExpiredController@update')
...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::get('account/confirm/{token}', 'ConfirmAccountController@confirm')
        ->name('account.confirm');

    Route::get('account/confirm/resend/{uuid}', 'ConfirmAccountController@sendConfirmationEmail')
