...
trait LabAttribute
{
    ...
    {
        return '<a href="' . route('admin.reservation.storeTimeUserIndex', $this) . '" class="btn btn-primary"><i class="fas fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
    }
