    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend'            => 'حساب شما تأیید نشده است لطفا روی پیوند تأیید در رایانامه خود کلیک کنید یا برای ارسال مجدد تأیید رایانامه <a href="'.route('account.confirm.resend', ':user_uuid').'">اینجا</a> را کلیک کنید.',
