...
@section('content')
                ...
                @if(isNurse())
                    <div class="col-sm-7 pull-right">
                        <div class="btn-toolbar float-right" role="toolbar"
                            ...
                            <a href="{{ route('admin.nurse.create', ['nurse' => $logged_in_user->id]) }}"
            ...
            <div class="card">
                ...
                <div id="collapsePanel" class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div>Doctors</div>
                            {!! Form::select('doctors[]', app(\App\Methods\GeneralMethods::class)->getAllNurses(), null, ['id' => 'doctors', 'class' => 'form-control select2_class_doctor', 'multiple' => 'multiple']); !!}
                        </div>
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.load-table').load('{{route('admin.nurse.index')}}?view=true', function () {
                intDeleteButton();
            });
            ...
            body.on('click', '#search_btn', function (e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{route('admin.nurse.index')}}?view=true",
                    data: {
                        doctors: $("#doctors").val(),
                        clinics: $("#clinics").val(),
